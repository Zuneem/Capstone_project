...
def place_order(new_dict):
    ...
    try:
        ...
        time.sleep(t)
        add1 = browser.find_element(
            By.XPATH, '//*[@id="addToCartButton"]/span')
        add1.click()
        time.sleep(t)
    ...
    cart = browser.find_element(
        By.XPATH, '//*[@id="page"]/div/div[1]/div[3]/ul/li[5]/a[1]')
    cart.click()
    time.sleep(25)
